...
MyGuitar 是一套以 Vue 3 Composition API 為核心的吉他電商前端系統，提供商品列表、商品詳情、購物車、結帳表單與訂單查詢等完整購物流程。專案整合 Bootstrap 5 打造響應式介面，並使用 vee-validate 處理表單驗證、Swiper 實現商品輪播、mitt 進行跨元件事件溝通。
